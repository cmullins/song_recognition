 ...
 * 
 */
public class EquallyDistributedTimeStarBuffer extends StarBuffer {
	...
	protected static class Builder extends StarBuffer.Builder {
		...
		public StarBuffer create(Spectrogram spec) {
			return new EquallyDistributedTimeStarBuffer(spec, starDensityFactor);
		}
	 ...
	 */
	public EquallyDistributedTimeStarBuffer(Spectrogram spec, double starDensityFactor) {
		super(spec);
