...
public class Settings implements Serializable {
	...
	/**
	 * If a score isn't above this, it will be rejected and an answer of "iuno" will be
	 * returned.
	 */
	 ...
	 */
	private double starDensityFactor = 0.40d;
	 ...
	 */
	private double frameOverlap = 0.35d;
	...
	private StatefulPeakDetector.Builder peakDetector
		= StatefulPeakDetector.meanDelta(100).withSmoothingFunction(StatefulSmoothingFunction.exponentialSmoother(0.1));

	/**ll usually involve some calculation
	 * using {@link #starDensityFactor}.
	 */
	private StarBuffer.Builder starSelectionBuffer
		= StarBuffer.coordinateAgnostic(starDensityFactor);
	...
	private Region.Builder regionBuilder
		= Region.rectangularRegion(1, -15, 30, 100);
...
//		= HistogramScorer.downshiftingHeightScorer(0.80, true);
	
	/**
	 * This extracts hash values from a spectrogram.
	 */
	private StarHashExtractor starHashExtractor
		= new StarHashExtractor(constellationExtractor, regionBuilder, timeResolution, progressNotifer);
	...
	public Settings setAcceptThreshold(double acceptThreshold) {
