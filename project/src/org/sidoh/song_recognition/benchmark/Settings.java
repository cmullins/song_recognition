...
public class Settings implements Serializable {
	 ...
	 */
	private double starDensityFactor = 0.05d;
	
	/**
	 * Controls how granular time is in signatures, etc.
	 */
	private int timeResolution = 100000;
	 ...
	 */
	private double frameOverlap = 0.15d;
	...
	private StatefulPeakDetector.Builder peakDetector
		= StatefulPeakDetector.sdsFromMean(200,4.5);

	/**
	 * This controls how stars are selected. It will usually involve some calculation
	...
	private Region.Builder regionBuilder
		= Region.rectangularRegion(1, -20, 40, 100);
	...
	private HistogramScorer histogramScorer
		= HistogramScorer.downshiftingHeightScorer(0.01, true);
